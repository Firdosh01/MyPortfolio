  ...
  return (
    <div name="about" className='w-full h-screen text-white bg-gradient-to-b from-gray-800 to-black'>
        ...
        <div className='flex flex-col justify-center w-full h-full max-w-screen-lg p-4 mx-auto '>
            ...
            <p className='mt-20 text-xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis est illo, sapiente qui ipsum nobis? Aliquid veniam quos consequuntur ea corporis excepturi
